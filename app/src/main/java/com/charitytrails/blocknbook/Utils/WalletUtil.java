...
public class WalletUtil {
     ...
     */
    public static MaskedWalletRequest createMaskedWalletRequest(Hotel itemInfo,
                                                                String publicKey) {
     ...
     * @return {@link MaskedWalletRequest} instance
     */
    public static MaskedWalletRequest createStripeMaskedWalletRequest(Hotel itemInfo,
    ...
    private static MaskedWalletRequest createMaskedWalletRequest(Hotel itemInfo,
                                                                 PaymentMethodTokenizationParameters parameters) {
     ...
     */
    private static List<LineItem> buildLineItems(Hotel itemInfo, boolean isEstimate) {
        List<LineItem> list = new ArrayList<LineItem>();
        String itemPrice = toDollars(itemInfo.getPrice());
        ...
        String shippingPrice = toDollars(
                isEstimate ? itemInfo.getPrice() : itemInfo.getPrice());
     ...
     */
    public static FullWalletRequest createFullWalletRequest(Hotel itemInfo,
