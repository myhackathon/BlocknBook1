package com.charitytrails.blocknbook.Controller;
...
import com.charitytrails.blocknbook.Utils.HotelsProvider;
...
public class HotelManager {
    ...
    public void searchHotels(String location) {
        ...
        Cursor cursor = contentResolver.query(hotels, null, "location LIKE ?", new String[]{ "%" }, "price");
